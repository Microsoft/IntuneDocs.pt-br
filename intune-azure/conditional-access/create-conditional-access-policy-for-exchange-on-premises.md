...
- É preciso usar o [conector do Exchange local do Exchange Active Sync](install-intune-on-premises-exchange-connector.md), que conecta o Intune ao Exchange local.
