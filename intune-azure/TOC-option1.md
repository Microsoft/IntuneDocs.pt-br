...
## <a name="what-is-the-azure-portal-previewintune-azureintroductionwhat-is-microsoft-intune"></a>[O que é a visualização do Portal do Azure?](/intune-azure/introduction/what-is-microsoft-intune)
...
## <a name="what-is-device-enrollmentintune-azureenroll-deviceswhat-is"></a>[Qual é o registro de dispositivos?](/intune-azure/enroll-devices/what-is)
...
### <a name="map-device-groupsintune-azureenroll-deviceshow-to-use-device-group-mapping"></a>[Mapear grupos de dispositivos](/intune-azure/enroll-devices/how-to-use-device-group-mapping)
...
## <a name="what-is-user-managementintune-azuremanage-userswhat-is"></a>[O que é o gerenciamento de usuário?](/intune-azure/manage-users/what-is)
...
## <a name="what-is-app-managementintune-azuremanage-appswhat-is-app-management"></a>[O que é o gerenciamento de aplicativo?](/intune-azure/manage-apps/what-is-app-management)
...
#### <a name="selectively-wipe-appsintune-azuremanage-appsapp-selective-wipe"></a>[Apagar aplicativos seletivamente](/intune-azure/manage-apps/app-selective-wipe)
<!---Is this specific to app protection policy or more general app management?--->
#### <a name="work-with-volume-purchased-appsintune-azuremanage-appsvolume-purchased-apps"></a>[Trabalhar com aplicativos comprados por volume](/intune-azure/manage-apps/volume-purchased-apps)
...
#### <a name="configure-the-company-portal-appintune-azuremanage-appscompany-portal-app"></a>[Configurar o aplicativo do Portal da Empresa](/intune-azure/manage-apps/company-portal-app)
...
### <a name="how-to"></a>Como
#### <a name="create--deploy-app-protection-policiesintune-azuremanage-appsapp-protection-policies"></a>[Criar e implantar políticas de proteção do aplicativo](/intune-azure/manage-apps/app-protection-policies)
##### <a name="android-settingsintune-azuremanage-appsandroid-app-protection-policy-settings"></a>[Configurações do Android](/intune-azure/manage-apps/android-app-protection-policy-settings)
##### <a name="ios-settingsintune-azuremanage-appsios-app-protection-policy-settings"></a>[Configurações do iOS](/intune-azure/manage-apps/ios-app-protection-policy-settings)
#### <a name="validate-app-protection-policiesintune-azuremanage-appsvalidate-app-protection-policies"></a>[Validar políticas de proteção do aplicativo](/intune-azure/manage-apps/validate-app-protection-policies)
#### <a name="monitor-app-protection-user-statusintune-azuremanage-appsmonitor-app-protection-policies-with-microsoft-intune"></a>[Monitorar o status de usuário de proteção do aplicativo](/intune-azure/manage-apps/monitor-app-protection-policies-with-microsoft-intune)
#### <a name="manage-data-transfer-between-ios-appsintune-azuremanage-appsmanage-data-transfer-between-ios-apps-with-microsoft-intune"></a>[Gerenciar a transferência de dados entre aplicativos iOS](/intune-azure/manage-apps/manage-data-transfer-between-ios-apps-with-microsoft-intune)
#### <a name="android-apps-with-app-protection-policiesintune-azuremanage-appsapp-protection-enabled-android-apps"></a>[Aplicativos Android com políticas de proteção do aplicativo](/intune-azure/manage-apps/app-protection-enabled-android-apps)
...
## <a name="how-to"></a>Como
### <a name="configure-device-profilesintune-azureconfigure-deviceshow-to-create-device-profiles"></a>[Configurar perfis do dispositivo](/intune-azure/configure-devices/how-to-create-device-profiles)
### <a name="configure-device-restrictionsintune-azureconfigure-deviceshow-to-configure-device-restrictions"></a>[Configurar restrições do dispositivo](/intune-azure/configure-devices/how-to-configure-device-restrictions)
...
### <a name="configure-email-settingsintune-azureconfigure-deviceshow-to-configure-email-settings"></a>[Definir configurações de email](/intune-azure/configure-devices/how-to-configure-email-settings)
...
### <a name="configure-vpn-settingsintune-azureconfigure-deviceshow-to-configure-vpn-settings"></a>[Definir configurações de VPN](/intune-azure/configure-devices/how-to-configure-vpn-settings)
...
### <a name="configure-wi-fi-settingsintune-azureconfigure-deviceshow-to-configure-wi-fi-settings"></a>[Definir configurações de Wi-Fi](/intune-azure/configure-devices/how-to-configure-wi-fi-settings)
...
#### <a name="windows-81--windows-10intune-azureconfigure-deviceswi-fi-import-for-windows-8-1"></a>[Windows 8.1 e Windows 10](/intune-azure/configure-devices/wi-fi-import-for-windows-8-1)

### <a name="configure-windows-10-edition-upgrade-settingsintune-azureconfigure-deviceshow-to-configure-windows-10-edition-upgrade"></a>[Definir configurações de atualização de edição do Windows 10](/intune-azure/configure-devices/how-to-configure-windows-10-edition-upgrade)
...
### <a name="configure-windows-information-protection-settingsintune-azureconfigure-deviceshow-to-configure-windows-information-protection"></a>[Definir configurações da Proteção de Informações do Windows](/intune-azure/configure-devices/how-to-configure-windows-information-protection)
### <a name="configure-ios-education-settingsintune-azureconfigure-deviceseducation-settings-for-ios"></a>[Definir as configurações de Educação do iOS](/intune-azure/configure-devices/education-settings-for-ios)

### <a name="configure-custom-settingsintune-azureconfigure-deviceshow-to-configure-custom-settings"></a>[Definir configurações personalizadas](/intune-azure/configure-devices/how-to-configure-custom-settings)
...
##### <a name="wi-fi-profile-with-a-pre-shared-keyintune-azureconfigure-deviceswi-fi-profile-with-shared-key"></a>[Perfil de Wi-Fi com uma chave pré-compartilhada](/intune-azure/configure-devices/wi-fi-profile-with-shared-key)
##### <a name="per-app-vpn-profileintune-azureconfigure-devicesper-app-vpn-for-android-pulse-secure"></a>[Perfil VPN por aplicativo](/intune-azure/configure-devices/per-app-vpn-for-android-pulse-secure)
##### <a name="allowblock-apps-for-samsung-knox-standardintune-azureconfigure-devicescustom-policy-to-allow-and-block-samsung-knox-apps"></a>[Permitir/bloquear aplicativos para o Samsung KNOX Standard](/intune-azure/configure-devices/custom-policy-to-allow-and-block-samsung-knox-apps)
...
### <a name="assign-device-profilesintune-azureconfigure-deviceshow-to-assign-device-profiles"></a>[Atribuir perfis de dispositivo](/intune-azure/configure-devices/how-to-assign-device-profiles)
### <a name="monitor-device-profilesintune-azureconfigure-deviceshow-to-monitor-device-profiles"></a>[Monitorar perfis de dispositivo](/intune-azure/configure-devices/how-to-monitor-device-profiles)
...
## <a name="how-to"></a>Como
### <a name="create-android-compliance-profileintune-azureset-device-compliancecreate-a-compliance-profile-for-android"></a>[Criar um perfil de conformidade Android](/intune-azure/set-device-compliance/create-a-compliance-profile-for-android)
### <a name="create-android-for-work-compliance-profileintune-azureset-device-compliancecreate-a-compliance-profile-for-android-for-work"></a>[Criar perfil de conformidade do Android para Trabalho](/intune-azure/set-device-compliance/create-a-compliance-profile-for-android-for-work)
### <a name="create-ios-compliance-profileintune-azureset-device-compliancecreate-a-compliance-profile-for-ios"></a>[Criar perfil de conformidade iOS](/intune-azure/set-device-compliance/create-a-compliance-profile-for-ios)
### <a name="create-windows-compliance-profileintune-azureset-device-compliancecreate-a-compliance-profile-for-windows"></a>[Criar um perfil de conformidade Windows](/intune-azure/set-device-compliance/create-a-compliance-profile-for-windows)
### <a name="monitor-device-complianceintune-azureset-device-compliancemonitor-device-compliance"></a>[Monitorar a conformidade do dispositivo](/intune-azure/set-device-compliance/monitor-device-compliance)
