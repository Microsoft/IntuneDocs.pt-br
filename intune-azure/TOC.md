...
#### [Apple Configurator – registro direto](enroll-devices/enroll-ios-devices-with-apple-configurator-and-direct-enrollment.md)
...
### [Gerenciador de registro de dispositivos](enroll-devices/enroll-devices-using-device-enrollment-manager.md)
...
### [Registrar em massa os dispositivos Windows](enroll-devices/bulk-enroll-windows.md)
...
#### [Mapear dispositivos para grupos](enroll-devices/how-to-use-device-group-mapping.md)
...
#### [Aplicativos LOB para Android](manage-apps/android-lob-app.md)
...
### [Configurar recursos do dispositivo](configure-devices/how-to-configure-device-features.md)
...
#### [Layout de tela de início para iOS](configure-devices/home-screen-settings-for-ios.md)
#### [Notificações de aplicativo para iOS](configure-devices/app-notification-settings-for-ios.md)
#### [Dispositivos compartilhados para iOS](configure-devices/shared-device-settings-for-ios.md)
...
### [Definir configurações de Wi-Fi](configure-devices/how-to-configure-wi-fi-settings.md)
...
# Configurar conformidade do dispositivo
...
### [Criar e atribuir a política de acesso condicional](conditional-access/create-conditional-access-policy-for-exchange-on-premises.md)
### [Monitorar a conformidade de acesso condicional](conditional-access/monitor-conditional-access-compliance-for-on-premises-exchange-and-exchange-online.md)
