...
[Criar uma política de proteção de aplicativo WIP](https://docs.microsoft.com/intune-azure/manage-apps/create-windows-information-protection-policy-with-intune)
