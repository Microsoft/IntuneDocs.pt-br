---
title: "Como adicionar aplicativos de linha de negócios Android ao Intune | Versão prévia do Intune Azure | Microsoft Docs"
...
# <a name="how-to-add-android-line-of-business-lob-apps-to-intune"></a>Como adicionar aplicativos de LOB (linha de negócios) do Android ao Intune
...
Na folha **Selecionar arquivo de instalação**, clique no botão Procurar e navegue até o arquivo de configuração de aplicativo do Android (com a extensão .apk) e clique em **OK**.
