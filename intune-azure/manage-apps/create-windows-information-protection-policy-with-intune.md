...
-   Saiba mais sobre [como configurar seu provedor MAM com o Intune](https://docs.microsoft.com/intune-azure/manage-apps/get-ready-to-configure-app-protection-policies-for-windows-10).
