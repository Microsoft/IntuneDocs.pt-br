...
Atribua o perfil aos dispositivos iOS necessários. Para saber mais, use as etapas em [Como atribuir perfis de dispositivo](../configure-devices/how-to-assign-device-profiles.md).
