...
# <a name="vpn-settings-for-windows-phone-81-devices-in-intune-azure-preview"></a>Configurações de VPN para dispositivos Windows Phone 8.1 na versão prévia do Intune Azure
