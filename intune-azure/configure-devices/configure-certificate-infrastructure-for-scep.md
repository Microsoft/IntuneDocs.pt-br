---
title: "Configurar a infraestrutura de certificado para o SCEP | Versão prévia do Intune Azure | Microsoft Docs"
description: "Versão prévia do Intune Azure: saiba como configurar sua infraestrutura antes de criar e implantar perfis de certificado SCEP no Intune."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
---
# <a name="configure-certificate-infrastructure-for-scep-in-intune-azure-preview"></a>Configurar a infraestrutura de certificado para o SCEP na versão prévia do Intune Azure
...
Agora você está pronto para configurar perfis de certificado, conforme descrito em [Configure certificate profiles](how-to-configure-certificates.md) (Configurar perfis de certificado).
