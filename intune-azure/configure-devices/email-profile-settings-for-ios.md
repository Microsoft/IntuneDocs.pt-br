...
# <a name="email-profile-settings-for-ios-devices-in-intune-azure-preview"></a>Configurações de perfil de email para dispositivos iOS na versão prévia do Intune Azure
