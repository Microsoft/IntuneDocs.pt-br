...
# <a name="intune-wi-fi-settings-for-android-devices-in-intune-azure-preview"></a>Configurações Wi-Fi para dispositivos Android na versão prévia do Intune Azure
