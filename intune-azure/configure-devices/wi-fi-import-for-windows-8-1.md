...
# <a name="how-to-import-wi-fi-settings-for-windows-81-and-later-devices-in-intune-azure-preview"></a>Como importar configurações de Wi-Fi para dispositivos Windows 8.1 e posteriores na versão prévia do Intune Azure
