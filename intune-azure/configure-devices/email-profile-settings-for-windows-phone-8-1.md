...
# <a name="email-profile-settings-for-windows-phone-81-devices-in-intune-azure-preview"></a>Configurações de perfil de email para dispositivos Windows Phone 8.1 na versão prévia do Intune Azure
