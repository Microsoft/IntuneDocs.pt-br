...
| A senha expirou. | Defina uma nova senha. Sua organização exige que você altere sua senha após um determinado número de dias. |
| Sua senha foi usada muito recentemente.| Escolha uma senha que você nunca usou antes. Sua organização requer que uma determinada quantidade de tempo passe antes de reutilizar uma senha. |
