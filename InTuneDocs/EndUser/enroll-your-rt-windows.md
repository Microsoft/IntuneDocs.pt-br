---
title: Registrar seu dispositivo Windows RT no Intune| Microsoft Intune
description: Descreve como registrar um dispositivo Windows RT no Intune
keywords: 
author: Staciebarker
manager: angrobe
ms.date: 06/27/2016
...
# Registrar seu dispositivo Windows RT no Intune

Essas instruções são para um dispositivo Windows RT anterior ao 8.1. Se você tiver um dispositivo Windows RT 8.1, siga as etapas em [Registrar seu dispositivo Windows 8.1 ou Windows RT 8.1 no Intune](enroll-your-w81-or-rt81-windows.md).
...
Para registrar seu dispositivo Windows RT:

1.  Toque em **Iniciar** e digite **Configuração do Sistema**.

2.  Toque na caixa de diálogo para abrir os **Aplicativos da Empresa**. Pode ser solicitado que você aceite os Termos e Condições da sua empresa.

3.  Entre usando as suas credenciais.
