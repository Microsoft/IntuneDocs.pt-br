...
Sua organização exige que você habilite a Integridade de Código do Windows. Esse recurso verifica os drivers e arquivos do sistema em seu dispositivo para certificar-se de que eles estão seguros.
...
Se você estiver usando um computador, será possível entrar em contato com o administrador de TI. Você também pode consultar a seção “Como reabilitar a Inicialização Segura” na página [Desabilitar Inicialização Segura](https://msdn.microsoft.com/library/windows/hardware/dn898540(v=vs.85).aspx) para tentar habilitar a Inicialização Segura por conta própria.
