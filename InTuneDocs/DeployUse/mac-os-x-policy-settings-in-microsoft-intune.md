...
title: Configurações de política do Mac OS X no Microsoft Intune | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
> [!TIP]
> Para obter mais informações sobre relatórios do Intune, consulte [Understand Microsoft Intune operations by using reports (Entender as operações do Microsoft Intune usando relatórios)](understand-microsoft-intune-operations-by-using-reports.md).
