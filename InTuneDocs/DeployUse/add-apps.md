...
> [!TIP]
> As opções para dispositivos móveis não estão disponíveis até que você [defina a autoridade de MDM](get-ready-to-enroll-devices-in-microsoft-intune.md) para o Intune.
