...
#### [Configurações do Android](android-policy-settings-in-microsoft-intune.md)
...
### [Controlar as configurações do Microsoft Passport em dispositivos](control-microsoft-passport-settings-on-devices-with-microsoft-intune.md)
...
### [Adicionar aplicativos para dispositivos móveis](add-apps-for-mobile-devices-in-microsoft-intune.md)
### [Adicionar aplicativos para computadores Windows](add-apps-for-windows-pcs-in-microsoft-intune.md)
...
#### [Para Android](android-compliance-policy-settings-in-microsoft-intune.md)
#### [Para iOS](ios-compliance-policy-settings-in-microsoft-intune.md)
#### [Para Windows e Windows Phone](windows-compliance-policy-settings-in-microsoft-intune.md)
...
### [Restringir o acesso ao email e aos serviços O365](restrict-access-to-email-and-o365-services-with-microsoft-intune.md)
...
### [Proteger dados do aplicativo](protect-app-data-using-mobile-app-management-policies-with-microsoft-intune.md)
...
#### [Experiência do usuário final](end-user-experience-for-mam-enabled-apps-with-microsoft-intune.md)
...
## [O que dizer aos seus usuários finais](what-to-tell-your-end-users-about-using-microsoft-intune.md)
