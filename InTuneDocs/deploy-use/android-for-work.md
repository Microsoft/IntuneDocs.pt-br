...
[Habilitando o registro do Android para Trabalho](https://docs.microsoft.com/intune/deploy-use/set-up-android-for-work)

[Implantando aplicativos do Android para Trabalho](https://docs.microsoft.com/intune/deploy-use/android-for-work-apps)
