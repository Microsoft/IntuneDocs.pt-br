...
### <a name="microsoft-intune-administrator-consolehttpsadminmanagemicrosoftcom"></a>[Console do administrador do Microsoft Intune](https://admin.manage.microsoft.com/)
