...
Antes de iniciar a configuração do [!INCLUDE[wit_firstref](../includes/wit_firstref_md.md)], você deve examinar a [Introdução ao Intune](/intune/understand-explore/introduction-to-microsoft-intune) e familiarizar-se com as funcionalidades do [!INCLUDE[wit_nextref](../includes/wit_nextref_md.md)] descritas nessa seção. Depois de familiarizar-se com as funcionalidades do Intune, você estará pronto para configurar sua assinatura paga. Se você tiver começado com uma assinatura de avaliação, mais tarde poderá convertê-la em uma assinatura completa. Consulte [How to buy Microsoft Intune](http://www.microsoft.com/en-us/server-cloud/products/microsoft-intune/Purchasing.aspx) (Como comprar o Microsoft Intune).

### Gerenciar dispositivos móveis e computadores sem requisitos de servidor ou da intranet
Você pode gerenciar dispositivos móveis e computadores, mesmo que esses dispositivos não façam parte de um domínio ou não estejam fisicamente no local. Por isso, o [!INCLUDE[wit_nextref](../includes/wit_nextref_md.md)] é ideal para empresas com uma força de trabalho móvel ou distribuída geograficamente.
...
[!INCLUDE[wit_nextref](../includes/wit_nextref_md.md)] dá suporte para MFA (Multi-Factor Authentication). Para saber detalhes, consulte [Protect Windows devices with multi-factor authentication](/intune/deploy-use/protect-windows-devices-with-multi-factor-authentication) (Proteger dispositivos Windows com Multi-Factor Authentication).

### Disponível em vários idiomas
O Intune está disponível nos seguintes idiomas: chinês (simplificado e tradicional), tcheco, dinamarquês, holandês, inglês, finlandês, francês, alemão, grego, húngaro, italiano, japonês, coreano, norueguês, polonês, português, romeno, russo, espanhol, sueco, turco. Para obter uma lista dos países em que o serviço [!INCLUDE[wit_nextref](../includes/wit_nextref_md.md)] tem suporte, consulte [International availability](https://products.office.com/en-us/business/international-availability) (Disponibilidade internacional).
