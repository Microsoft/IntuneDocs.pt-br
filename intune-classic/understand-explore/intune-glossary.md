...
|Ferramenta de Encapsulamento de Aplicativo|Um [aplicativo de linha de comando](/intune/apps-prepare-mobile-application-management) que cria um wrapper em um aplicativo de linha de negócios e, em seguida, permite que o aplicativo seja gerenciado por uma política de gerenciamento de aplicativos móveis do Intune.|
