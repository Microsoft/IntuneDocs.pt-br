...
Uma lista de dispositivos Samsung KNOX com suporte pode ser encontrada junto com a lista de [dispositivos com suporte do Intune](/intune/supported-devices-browsers.md#intune-supported-devices).
