...
2. Pesquise nos arquivos XML para localizar aquele com o nome correto.
3. Depois de localizar o arquivo XML correto, copie e cole o código XML no campo de Dados da página de configurações de OMA-URI.
