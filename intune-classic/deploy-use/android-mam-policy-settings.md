...
> [!IMPORTANT]
No momento, o conteúdo desta página está amplamente desatualizado, porque as políticas de proteção de aplicativo do Intune migraram inteiramente para o Portal do Azure. Saiba mais sobre as [políticas de proteção de aplicativo Intune para Android no portal do Azure](https://docs.microsoft.com/intune/app-protection-policy-settings-android).
