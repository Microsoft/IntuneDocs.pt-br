...
-   Saiba mais sobre [como configurar seu provedor MAM com o Intune](/intune-classic/deploy-use/get-ready-to-configure-app-protection-policies-for-windows-10).
...
Depois de configurar o Intune em sua organização, você poderá criar uma política específica WIP por meio do [Portal do Azure](/intune-classic/deploy-use/azure-portal-for-microsoft-intune-mam-policies).
