...
- [Examinar as portas e URLs de rede necessárias](../get-started/network-bandwidth-use.md)
- [Adicionar e verificar o nome de domínio](../get-started/start-with-a-paid-subscription-to-microsoft-intune-step-2.md)
