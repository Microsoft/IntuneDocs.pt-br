...
Um MDM Push Certificate é necessário para registrar dispositivos iOS/iPadOS e macOS. Saiba mais sobre [MDM push certificates](apple-mdm-push-certificate-get.md).
