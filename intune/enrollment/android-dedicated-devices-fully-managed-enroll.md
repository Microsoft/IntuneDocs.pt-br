...
Após configurar seus [dispositivos Android Enterprise dedicados](android-kiosk-enroll.md) ou [dispositivos totalmente gerenciados](android-fully-managed-enroll.md) no Intune, será possível registrá-los. O registro do Intune para dispositivos dedicados e totalmente gerenciados começa com uma redefinição de fábrica. A maneira como você registra seus dispositivos Android Enterprise depende do sistema operacional.
