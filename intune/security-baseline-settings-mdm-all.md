...
- **Prompt automático da zona Internet do Internet Explorer para** downloads de arquivo > o valor padrãoa gora está **desabilitado**. Em visualização, isso foi definido como habilitado.
