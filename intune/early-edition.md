...
---
# A edição antecipada do Microsoft Intune – julho de 2017
...
## Quais são as novidades do Intune no portal do Azure
<a id="whats-coming-to-intune-on-the-azure-portal" class="xliff"></a>

### Instalação mais fácil de aplicativos do Office 365 <!--- 1121362 --->
...
### Nova ação de dispositivo para forçar os dispositivos a sincronizarem com o Intune <!-- 711369 -->
...
### Ações para não conformidade <!--730266-->
...
### Restringir a restrição de registro de dispositivo Android e iOS por versão do sistema operacional  <!--- 1333256,  1245463 --->
...
### Restringir o registro de dispositivos de pessoais Android, iOS e macOS  <!--- 1333272,  1333275, 1245709 --->
...
### Forçar os dispositivos iOS supervisionados a instalarem automaticamente a atualização de software mais recente disponível <!-- 777100 -->
...
### Novas configurações para permitir e bloquear aplicativos em dispositivos Samsung KNOX Standard  <!-- 822899,  1305423-->
...
### Suporte do Android for Work no Lookout <!-- 1087312 -->
...
### Check Point SandBlast Mobile – Novo parceiro de Defesa contra Ameaças Móveis  <!-- 954651  and  1172027 ? -->
...
#### Como a integração com o Intune funciona?
...
### Zimperium – Novo parceiro de Defesa contra Ameaças Móveis   <!-- 954681 -->
...
### Suporte de alta disponibilidade do Exchange Connector local  <!-- 676614 -->
...
### Pacote de gerenciamento do System Center Operations Manager para Exchange Connector <!-- 885457 -->
...
### Suporte a acesso condicional para dispositivos Mac  <!-- 720172 -->
...
### Fim do suporte para iOS 8.0 <!---1164477--->
...
### Fim do suporte para Android 4.3 e inferior <!---1171127--->
...
### Lembrete de suporte de plataforma: o suporte base do Windows Phone 8.1 terminará em 11 de julho de 2017 <!-- 1327781 -->
...
## Quais são as novidades dos aplicativos do Intune
...
### Modos claro e escuros disponíveis para o aplicativo de Portal da Empresa para Windows 10 <!---676547--->
...
### Habilitar que os usuários finais marquem seu grupo de dispositivos no aplicativo de Portal da Empresa para Windows 10 <!---807046-->
...
### Permitir que os usuários finais acessem o aplicativo de Portal da Empresa para Android sem registro <!---1169910--->
...
### Os usuários que se conectaram ao Exchange podem acessar automaticamente o site de Portal da Empresa em dispositivos Windows 10 <!--1323204-->
