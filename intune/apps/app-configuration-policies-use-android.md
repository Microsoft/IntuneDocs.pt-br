...
1. No [Intune](https://go.microsoft.com/fwlink/?linkid=2090973), escolha **Aplicativos cliente** > **Políticas de configuração de aplicativo** >  **Adicionar**.
