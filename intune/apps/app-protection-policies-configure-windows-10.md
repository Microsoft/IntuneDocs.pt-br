...
4. Escolha **Mobilidade (MDM e MAM)** , no grupo **Gerenciar**.
5. Clique em **Microsoft Intune**.
6. Defina as configurações no grupo **Restaurar as URLs padrão do MAM** do painel **Configurar**.
