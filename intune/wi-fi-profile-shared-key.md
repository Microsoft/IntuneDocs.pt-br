...
O exemplo a seguir inclui o código XML para um perfil de Wi-Fi do Windows ou do Android. 
...
O exemplo a seguir inclui o código XML para um perfil de Wi-Fi baseado em EAP:
