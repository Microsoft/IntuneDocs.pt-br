...
Há duas maneiras pelas quais você pode implantar o aplicativo do Portal da Empresa para macOS no Jamf Pro:

- Disponibilize a implantação do aplicativo do Portal da Empresa no Autoatendimento do Jamf ou,
- Como uma instalação em segundo plano para que os usuários sigam o procedimento abaixo:

1. Em um dispositivo macOS, baixe a versão atual do [aplicativo do Portal da Empresa para macOS](https://go.microsoft.com/fwlink/?linkid=862280).
...
2. Configure o conteúdo **Integração do Microsoft Intune**, incluindo a frequência de disparo e de execução. Defina a prioridade como **Após**.
