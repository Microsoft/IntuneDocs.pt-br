...
Escolha **Dispositivos** > **Monitor** > **Ações do dispositivo** para ver o status da ação de sincronização.

Você pode encontrar frequências padrão de check-in de política do Intune em [Tempos de ciclo de atualização](../configuration/device-profile-troubleshoot.md#how-long-does-it-take-for-devices-to-get-a-policy-profile-or-app-after-they-are-assigned).
