...
#### <a name="sharedpcconfigurationaccountmanagerpolicy-windows-holographic-for-business-edition-targeted-devices"></a>SharedPCConfiguration.AccountManagerPolicy (Windows Holographic for Business edition direcionado registrados) 
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI de deslocamento**: / configurações/AllowPersistence
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI de deslocamento**: / configurações/PrintingSettings
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI de deslocamento**: / configurações/ClipboardSettings
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI de deslocamento**: / configurações/ClipboardFileType
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**URI de deslocamento**: / configurações/BlockNonEnterpriseContent
...
**CSP**: ./Vendor/MSFT/Firewall  
**URI de deslocamento**: /EnableFirewall, /DisableStealthMode, / blindado, /DisableUnicastResponsesToMulticastBroadcast, /DisableInboundNotifications, /AuthAppsAllowUserPrefMerge, /GlobalPortsAllowUserPrefMerge, /AllowLocalPolicyMerge , /DefaultOutboundAction, /DefaultInboundAction, /DisableStealthModeIpsecSecuredPacketExemption, /AllowLocalIpsecPolicyMerge
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_LANManagerAuthenticationLevel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/Accounts\_RenameAdministratorAccount
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_BehaviorOfTheElevationPromptForAdministrators
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/NetworkAccess\_RestrictClientsAllowedToMakeRemoteCallsToSAM
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_AllowUIAccessApplicationsToPromptForElevation
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/Accounts\_BlockMicrosoftAccounts
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/Shutdown\_ClearVirtualMemoryPageFile
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsAlways
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_DetectApplicationInstallationsAndPromptForElevation
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/Accounts\_EnableAdministratorAccountStatus
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsIfServerAgrees
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/Accounts\_EnableGuestAccountStatus
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsAlways
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsIfClientAgrees
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotRequireCTRLALTDEL
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/Devices\_AllowedToFormatAndEjectRemovableMedia
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/Accounts\_RenameGuestAccount
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotDisplayLastSignedIn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotDisplayUsernameAtSignIn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DisplayUserInformationWhenTheSessionIsLocked
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MessageTextForUsersAttemptingToLogOn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MessageTitleForUsersAttemptingToLogOn
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MachineInactivityLimit
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_MinimumSessionSecurityForNTLMSSPBasedClients
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_MinimumSessionSecurityForNTLMSSPBasedServers
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/NetworkAccess\_RestrictAnonymousAccessToNamedPipesAndShares
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_SmartCardRemovalBehavior
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_BehaviorOfTheElevationPromptForStandardUsers
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_UseAdminApprovalMode
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_RunAllAdministratorsInAdminApprovalMode
...
**CSP**: ./Vendor/MSFT/Policy  
**URI de compensação**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_VirtualizeFileAndRegistryWriteFailuresToPerUserLocations
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de compensação**: /Config/RemoteManagement/AllowBasicAuthentication\_cliente
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de compensação**: /Config/RemoteManagement/AllowBasicAuthentication\_serviço
...
**URI de deslocamento**: / MOMAgent/WorkspaceID e a WorkspaceKey/MOMAgent /
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI de deslocamento**: InBoxApps/WirelessProjection/canal
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI de deslocamento**: / propriedades/DoNotShowMyMeetingsAndFiles
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI de deslocamento**: / propriedades/AllowSessionResume
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI de deslocamento**: / propriedades/ScreenTimeout
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI de deslocamento**: / propriedades/SessionTimeout
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**URI de deslocamento**: / propriedades/SleepTimeout
...
**CSP**: ./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**URI de deslocamento**: / configuração/SampleSharing
...
**CSP**: ./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**URI de deslocamento**: / configuração/TelemetryReportingFrequency
...
**URI de deslocamento**: / biometria/FacialFeaturesUseEnhancedAntiSpoofing
...
**URI de deslocamento**: / {AADTenantId} / políticas/PINComplexity/expiração
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI de deslocamento**: / {AADTenantId} / PINComplexity/políticas/histórico
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI de deslocamento**: / {AADTenantId} / políticas//Policies/enablepinrecovery
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI de deslocamento**: / {AADTenantId} / PINComplexity/políticas/SpecialCharacters
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI de deslocamento**: / {AADTenantId} / PINComplexity/políticas/UppercaseLetters
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI de deslocamento**: / RequireSecurityDevice/políticas / {AADTenantId}
...
**CSP**: ./Device/Vendor/MSFT/PassportForWork  
**URI de deslocamento**: / biometria/UseBiometrics
...
**CSP**: ./Device/Vendor/MSFT/PassportForWork  
**URI de deslocamento**: / UseCertificateForOnPremAuth/políticas / {AADTenantId}
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**URI de deslocamento**: / UsePassportForWork/políticas / {AADTenantId}
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de deslocamento**: /Config/Update/ScheduledInstallEveryWeek, /Config/Update/ScheduledInstallFirstWeek, /Config/Update/ScheduledInstallFourthWeek, /Config/Update/ScheduledInstallSecondWeek, /Config/atualização / ScheduledInstallThirdWeek
