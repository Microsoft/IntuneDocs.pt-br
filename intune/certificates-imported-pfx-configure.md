...
- **Conector do Certificado PFX do Microsoft Intune**:  
  ...
  Para obter mais informações sobre todos os pontos de extremidade de rede que o conector acessa, confira [Largura de banda e requisitos de configuração de rede do Intune](https://docs.microsoft.com/intune/network-bandwidth-use).
...
2. Siga as orientações para baixar o *Conector de Certificado PFX do Microsoft Intune* em um local acessível do servidor no qual você instalará o conector.
...
4. O Conector do Certificado PFX do Microsoft Intune abre a guia **Registro** após a instalação. Para habilitar a conexão com o Intune, **Entre** e insira uma conta com permissões de administrador do Intune ou administrador global do Azure.
...
5. Feche a janela.
6. No portal do Intune, retorne para **Configuração do Dispositivo** > **Conectores de Certificação**. Depois de alguns instantes, uma marca de seleção verde é exibida e o **Status da conexão** fica **Ativo**. O servidor do conector agora pode se comunicar com o Intune.
...
1. No portal do [Intune](https://go.microsoft.com/fwlink/?linkid=2090973), acesse **Configuração do dispositivo** > **Perfis** > **Criar perfil**.
