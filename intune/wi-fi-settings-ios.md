...
| Nome da configuração | Mais informações | Usar quando |
|---|---|---|
| **Certificado do cliente para autenticação de cliente (Certificado de identidade)**** |  Escolha o perfil de certificado SCEP ou PKCS usado para autenticar a conexão.  |    O tipo de EAP é **EAP-TLS**    |
