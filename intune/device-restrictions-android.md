...
Exemplo: pesquise a [seção de aplicativos do Google Play](https://play.google.com/store/apps) para encontrar **Microsoft Planner**. Use a URL: **https://play.google.com/store/apps/details?id=com.microsoft.planner**.
...
- **Adicionar aplicativos pelo nome do pacote** – usado principalmente para a aplicativos de linha de negócios. Insira o nome do aplicativo e o nome do pacote do aplicativo.
