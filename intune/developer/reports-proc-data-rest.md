...
8. Marque a caixa **Permissões Delegadas** para adicionar **Obter informações do data warehouse do Microsoft Intune**.
    ...
    ![Habilitar o acesso – API do Microsot Intune](./media/reports-proc-data-rest/reports-get_rest_data_client_access.png)
...
Por exemplo, a entidade **datas** tem a aparência: `https://fef.tenant.manage.microsoft.com/ReportingService/DataWarehouseFEService/dates?api-version=v1.0`
...
12. Selecione **Solicitar token**.
    ...
    ![Informações do token de acesso](./media/reports-proc-data-rest/reports-postman_getnewtoken.png)
...
2. Os dados de retorno são exibidos no corpo da resposta do Postman.
    ...
    ![O status do cliente do Postman é igual a 200 OK](./media/reports-proc-data-rest/reports-postman_200OK.png)
...
10. Pressione **Ctrl + F5** para compilar e executar o cliente Intune.DataWarehouseAPIClient no modo de depuração.
    ...
    ![Entidade de data recuperada no formato JSON.](./media/reports-proc-data-rest/reports-get_rest_data_output.png)
