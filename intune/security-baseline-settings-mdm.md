...
- **Configure o Windows Hello para Empresas**   
  O Windows Hello para Empresas é um método alternativo para entrar no Windows que substitui senhas, cartões inteligentes e cartões inteligentes virtuais. Se você habilitar ou não definir essa configuração de política, o dispositivo provisionará o Windows Hello para Empresas. Se você desabilitar essa configuração de política, o dispositivo não provisionará o Windows Hello para Empresas para nenhum usuário.
