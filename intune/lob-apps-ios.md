---
title: Como adicionar aplicativos de linha de negócios do iOS ao Microsoft Intune
titlesuffix: ''
description: Saiba como adicionar aplicativos de LOB (linha de negócios) do iOS ao Microsoft Intune.
keywords: ''
author: Erikre
ms.author: erikre
manager: dougeby
...
Use as informações deste artigo para ajudar a adicionar aplicativos de linha de negócios iOS ao Microsoft Intune.
...
2. No painel **Arquivo do pacote do aplicativo**, escolha o botão Procurar e selecione um arquivo de instalação do iOS com a extensão **.ipa**.
