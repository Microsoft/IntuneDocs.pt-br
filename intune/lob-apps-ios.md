...
Observação: para que o serviço do Intune implante com êxito um novo arquivo IPA para o dispositivo, incremente a cadeia de caracteres CFBundleVersion no arquivo Info.plist em seu pacote de IPA.
