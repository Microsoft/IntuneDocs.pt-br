...
1. [Criar uma política de proteção de aplicativo](../apps/app-protection-policies.md#create-an-app-protection-policy)
2. [Implantar uma política](../apps/app-protection-policies.md#deploy-a-policy-to-users)
