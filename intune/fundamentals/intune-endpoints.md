...
|-----------|----------------|
|login.microsoftonline.com <br> *.officeconfig.msocdn.com <br> config.office.com <br> graph.windows.net| Obtenha mais informações sobre [URLs e intervalos de endereços IP do Office 365](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2) |
...
## <a name="windows-push-notification-services-wns"></a>WNS (Serviços de Notificação por Push do Windows)  
...
Saiba mais em [Portas TCP e UDP usadas pelos produtos de software da Apple](https://support.apple.com/HT202944), [Sobre conexões de host do servidor do macOS, iOS/iPadOS e iTunes e processos em segundo plano do iTunes](https://support.apple.com/HT201999) e [Se seus clientes macOS e iOS/iPadOS não recebem notificações por push da Apple](https://support.apple.com/HT203609).  