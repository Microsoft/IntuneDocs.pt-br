...
O servidor que hospeda o Microsoft Intune Certificate Connector precisa ter acesso usando a porta **TCP** **443** às localizações de IP público listadas na tabela a seguir.  
