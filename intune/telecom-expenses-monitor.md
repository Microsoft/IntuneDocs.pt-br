...
1. No painel **Intune** do [Portal do Azure](https://portal.azure.com), escolha **Aplicativos móveis**.

2. No painel **Aplicativos móveis**, escolha **Gerenciar** > **Aplicativos**.
