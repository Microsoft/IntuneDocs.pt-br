...
- **Tipo de conexão**: selecione o tipo de conexão VPN na lista de fornecedores a seguir:
  ...
  Quando você escolhe um tipo de conexão VPN, também pode ser solicitado a fornecer as seguintes configurações:  
    - **Always On**: habilite para conectar-se automaticamente à conexão de VPN quando ocorrer o seguinte: 
...
=======
**Restringir a conexão VPN a estes aplicativos**: habilite essa configuração se quiser que apenas alguns aplicativos usem a conexão VPN.
...
- **Acesso condicional para esta conexão VPN**: habilita o fluxo de conformidade do dispositivo do cliente. Quando habilitada, o cliente da VPN tenta se comunicar com o Azure AD (Active Directory) para obter um certificado para usar na autenticação. A VPN deve ser configurada para usar a autenticação de certificado e o servidor VPN deve confiar no servidor retornado pelo Azure AD.
