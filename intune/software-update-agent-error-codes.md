...
A tabela a seguir relaciona os códigos de erro do **Agente de Atualização** do Intune. Se você não encontrar um código de erro específico nessa tabela, confira a [Lista de códigos de erro do Windows Update](https://support.microsoft.com/help/938205/windows-update-error-code-list).
