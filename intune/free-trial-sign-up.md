...
Saiba mais sobre o Intune em [Introduction to Microsoft Intune in the Azure portal preview](what-is-intune.md) (Introdução ao Microsoft Intune na visualização do Portal do Azure)
### <a name="classic-intune"></a>Intune clássico
Cenário de avaliação: [Avaliar o gerenciamento de dispositivo móvel no Microsoft Intune](https://docs.microsoft.com/intune-classic/understand-explore/mobile-device-management-trial-guide-microsoft-intune)
