...
Você poderá categorizar Microsoft Store para aplicativos de negócios. Para fazer isso, escolha **aplicativos** >  **cliente aplicativos** > **doIntune** > selecionar um aplicativo Microsoft Store para o **aplicativo de negócios >**  > **Categoriade**informações. No menu suspenso, atribua uma categoria.
...
Você poderá criar perfis para restringir as configurações em dispositivos que executam Ios e MacOS (**perfis** >  **de configuração** > **do dispositivo criar perfil**  > **Ios** ou**MacOS**para tipo de plataforma >**restriçõesde**dispositivo). Os seguintes recursos serão adicionados:
...
- Em **restrições** > dedispositivo**Ios, há algumas alterações:**
...
Você poderá**habilitar e configurar recursos em dispositivos MacOS (perfis** > **deconfiguraçãodo dispositivo criar**  > **perfil**  > **MacOS** para plataforma >**recursos** de dispositivo para tipo de perfil). 
...
Você poderá controlar recursos e configurações em uma experiência de estilo de quiosque em seus dispositivos Android Enterprise dedicados. Para fazer isso, escolha **configuração** > **dodispositivo** > perfis**Criarperfil** >  **Android Enterprise** somente para a **plataforma > proprietário do dispositivo,** restrições de dispositivo para o tipo de perfil.
...
- **Dispositivos** > **dedicadosváriosaplicativos** : **oacessoàlanterna** permite que os usuários usem a lanterna. 
...
Para fazer isso, acesse **registro**  >  **de dispositivo inscrição da**   > **Apple tokens do programa de registro > escolha um token >** **Perfis** > escolha um perfil > **propriedades** > **Editarao** lado **dapersonalização**do assistente de configuração.
Para obter mais informações sobre a personalização do assistente [de configuração, consulte Criar ](device-enrollment-program-enroll-ios.md#create-an-apple-enrollment-profile)um perfil de registro da Apple.
...
A opção de registro de administrador de dispositivo Android será adicionada à página de registro**do**Android ( >  **registro** > **de dispositivo do Intune Android Registro**). O administrador do dispositivo Android ainda estará habilitado por padrão para todos os locatários.  
...
Você poderá definir o limite de tempo de limpeza do dispositivo automático como 30 dias (em vez do limite atual de 90 dias) após a última entrada. Para fazer isso, vá para **dispositivos**  > **doIntune**  >  **configurarregrasdelimpezado** > **dispositivo**.
