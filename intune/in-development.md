...
ms.locfileid: "71166345"
---
# <a name="in-development-for-microsoft-intune---september-2019"></a>Em desenvolvimento para o Microsoft Intune – setembro de 2019
...
Os aplicativos do macOS que você comprou usando o Apple Business Manager serão exibidos no console quando os tokens de VPP da Apple são sincronizados no Intune. Você pode atribuir, revogar e reatribuir licenças baseadas no usuário e no dispositivo para grupos usando o console. O Microsoft Intune ajuda a gerenciar aplicativos VPP adquiridos para uso em sua empresa ao proporcionar:
...
Você poderá instalar os aplicativos Web, que permitem adicionar um atalho a uma URL na Web, no Dock usando o Portal da Empresa do macOS. Os usuários finais podem acessar a ação **Instalar** na página de detalhes de um aplicativo Web no Portal da Empresa do macOS. Para obter mais informações sobre o tipo de aplicativo de **link da Web** , consulte [adicionar aplicativos ao Microsoft Intune](apps-add.md).
...
- iOS
  - [Recursos de dispositivo](ios-device-features-settings.md)
  - [Restrições de dispositivo](device-restrictions-ios.md)

- macOS
  - [Recursos de dispositivo](macos-device-features-settings.md)
  - [Restrições de dispositivo](device-restrictions-macos.md)
