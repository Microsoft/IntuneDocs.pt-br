...
- O [Registro de dispositivo do Intune para administradores de TI](device-enrollment.md) explica como registrar dispositivos Mac, iOS e Android no Intune.
