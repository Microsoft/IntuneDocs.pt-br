...
Se um dispositivo não fizer o check-in para obter a política após a primeira notificação, o Intune fará mais três tentativas. Um dispositivo offline, como quando está desligado ou não conectado a uma rede, pode não receber as notificações. Nesse caso, o dispositivo obterá a política em seu próximo check-in agendado no serviço do Intune, que é:
...
Os dispositivos fazem o check-in no Intune quando recebem uma notificação ou durante o check-in agendado. Quando você direciona uma ação a um dispositivo ou usuário, como bloqueio, redefinição de senha, atribuição de aplicativo, atribuição de perfil ou atribuição de política, o Intune notifica imediatamente o dispositivo para fazer check-in a fim de receber essas atualizações.
