...
description: Saiba como usar o Apple Configurator para registrar dispositivos iOS de propriedade corporativa com o Assistente de Configuração (nova interface do usuário).
keywords: ''
author: ErikjeMS
ms.author: erikje
manager: dougeby
...
>
>Caso contrário, se a sua página de **Registro de dispositivo** for semelhante à imagem abaixo, sua conta ainda não foi atualizada para a nova interface do usuário. Vá para [esta página de ajuda](apple-configurator-enroll-ios.md).
>
...
2. Em **Registro Direto**, escolha **Baixar Perfil** e salve o arquivo.
