...
Para visualizar dados de monitoramento da linha de base e dos dispositivos, entre no [Centro de Administração do Gerenciador de Ponto de Extremidade da Microsoft](https://go.microsoft.com/fwlink/?linkid=2109431). Em seguida, selecione **Segurança de ponto de extremidade** > **Linhas de Base de Segurança**, selecione uma linha de base e visualize o painel **Visão Geral**.
...
Cada dispositivo é representado por um dos seguintes status (usados na exibição do *dispositivo* e nas exibições *por categoria*):
...
- **Não corresponde à linha de base** – pelo menos uma configuração na linha de base não corresponde às configurações recomendadas.
  ...
  > [!NOTE]
  > Quando você cria ou edita um perfil de linha de base, qualquer alteração feita em um valor padrão ou em uma configuração resulta no status "Não corresponde à linha de base". Para obter ajuda para determinar as configurações que foram alteradas, entre em contato com Suporte da Microsoft. 
...
## <a name="view-endpoint-security-configurations-per-device"></a>Exibir a configuração de segurança do ponto de extremidade por dispositivo

Veja detalhes sobre as configurações de segurança que se aplicam a um dispositivo individual, o que pode ajudar você a isolar as configurações que estão configuradas incorretamente.

1. Entre no [Centro de administração do Microsoft Endpoint Manager](https://go.microsoft.com/fwlink/?linkid=2109431).

2. Acesse **Dispositivos** > **Todos os dispositivos** e selecione o dispositivo cujo registro você deseja ver.

3. Na categoria *Monitor*, selecione **Configuração de segurança do ponto de extremidade** para exibir a lista de configurações de segurança que se aplicam a esse dispositivo.

4. Você pode selecionar uma configuração de segurança de ponto de extremidade para ver e analisar detalhes adicionais sobre a avaliação da configuração de segurança no dispositivo.
