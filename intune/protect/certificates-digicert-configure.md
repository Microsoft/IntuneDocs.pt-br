...
2. Crie um perfil de certificado confiável no portal do Intune:
   ...
   a. Entre no [Centro de Administração do Gerenciador de Ponto de Extremidade da Microsoft](https://go.microsoft.com/fwlink/?linkid=2109431).
   ...
   d. Selecione **Configurações**, procure o arquivo .cer do certificado de Autoridade de Certificação raiz confiável que você exportou para uso com esse perfil de certificado e selecione **OK**.

   e. Somente para dispositivos Windows 8.1 e Windows 10, selecione o **Repositório de Destino** para o certificado confiável de:
   ...
   f. Quando terminar, selecione **OK**, volte para o painel **Criar perfil** e selecione **Criar**.  
...
4. No painel **Certificado PKCS**, configure parâmetros com os valores da tabela a seguir. Esses valores são necessários para emitir certificados PKCS de uma AC DigiCert por meio do Intune Certificate Connector.
...
5. Conclua a configuração do perfil para atender às suas necessidades de negócios e selecione **Criar** para salvá-lo.

6. Na página *Visão geral* do novo perfil, selecione **Atribuições** e configure um grupo apropriado que receberá esse perfil. Pelo menos um usuário ou dispositivo deve fazer parte do grupo atribuído.
...
| --- | --- |
| Não é possível entrar com a conta de administrador de locatário do Intune na interface do usuário do Conector NDES. | Isso pode acontecer quando o conector de certificado local não está habilitado no Centro de Administração do Gerenciador de Ponto de Extremidade da Microsoft. Para resolver esse problema: <br><br> 1. Entre no [Centro de Administração do Gerenciador de Ponto de Extremidade da Microsoft](https://go.microsoft.com/fwlink/?linkid=2109431). <br> 2. Selecione **Administração de locatários** > **Conectores e tokens** > **Conectores de certificado**. <br> 3. Localize o conector de certificado e verifique se ele está habilitado. <br><br> Depois de concluir as etapas anteriores, tente entrar com a mesma conta de administrador de locatários do Intune na interface do usuário do Conector NDES. |
