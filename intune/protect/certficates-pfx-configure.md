...
- **Conector do Certificado PFX do Microsoft Intune**:  
  ...
  Para obter mais informações sobre todos os pontos de extremidade de rede que o Intune e o conector precisam acessar, confira [Pontos de extremidade de rede do Microsoft Intune](../fundamentals/intune-endpoints.md).
