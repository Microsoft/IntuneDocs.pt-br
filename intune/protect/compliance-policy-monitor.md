...
2. Escolha a guia **Dispositivos** > **Visão geral** > **Status de conformidade**.
...
Além de usar os gráficos no *Status de conformidade*, você pode acessar **Relatórios** > **Conformidade do dispositivo**.
