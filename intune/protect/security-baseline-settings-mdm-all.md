...
- **Nível de autenticação**:  
  ...
  - *Enviar somente resposta NTLMv2. Recusar o LM*-os clientes usam somente a autenticação NTLMv2 e usam a segurança de sessão NTLMv2 se o servidor oferecer suporte a ele. Os controladores de domínio recusam LM (aceitam somente autenticação NTLM e NTLMv2).
...
- **Permitir que os aplicativos de acesso de interface do usuário para locais seguros**:  
  ...
  - *Sim*: programas UIA, incluindo a Assistência Remota do Windows, desabilitam automaticamente a área de trabalho protegida para solicitações de elevação. Se você não desabilitar a configuração de política “Controle de Conta de Usuário: alternar para a área de trabalho protegida ao solicitar elevação”, os prompts serão exibidos na área de trabalho do usuário interativo em vez de na área de trabalho protegida.

  - *Não configurado*: a área de trabalho protegida só poderá ser desabilitada pelo usuário da área de trabalho interativa ou se a configuração de política “Controle de Conta de Usuário: alternar para a área de trabalho segura ao pedir elevação" for desabilitada.
...
- **Assistência remota solicitada**:  
  ...
  - *Se você desabilitar essa configuração de política*, os usuários neste computador não poderão usar o email ou a transferência de arquivos para pedir ajuda a alguém. Além disso, os usuários não podem usar programas de mensagens instantâneas para permitir conexões com este computador.
  ...
  **Padrão**: desabilitar a assistência remota
  ...
  - **Permissão solicitada da assistência remota**:  
    **Padrão**: exibição

  - **Valor do tempo máximo de tíquete**:  
...
- **Política de unidade de sistema do BitLocker** *(todas as configurações)*
...
- **Prompt automático da zona Internet do Internet Explorer para downloads de arquivo** > o valor padrão agora está **desabilitado**. Em visualização, essa configuração foi definida como habilitada.
