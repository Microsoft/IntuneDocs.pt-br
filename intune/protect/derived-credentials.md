...
Para obter detalhes importante sobre como usar os diferentes emissores, examine as diretrizes desse emissor, incluindo o fluxo de trabalho de usuário final dos emissores. Para obter mais informações, confira [Planejar credenciais derivadas](#plan-for-derived-credentials) neste artigo.
...
A seguir estão as principais considerações para cada parceiro com suporte e links para esse fluxo de trabalho de usuário final dos emissores.  Familiarize-se com essas informações para poder garantir que suas políticas e configurações do Intune não impeçam que usuários e dispositivos concluam com êxito o registro para uma credencial derivada desse emissor.
...
Examine o [fluxo de trabalho do usuário da Entrust Datacard](https://docs.microsoft.com/intune-user-help/enroll-ios-device-entrust). Os principais requisitos deste fluxo de trabalho incluem: 
