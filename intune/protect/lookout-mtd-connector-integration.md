...
Depois de configurar o Lookout MES, você deverá configurar uma conexão com o [Lookout no Intune](https://docs.microsoft.com/en-us/intune/protect/mtd-connector-enable).  
