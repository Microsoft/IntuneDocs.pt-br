...
10. Em seguida, forneça o consentimento do administrador para esse aplicativo selecionando **Fornecer o consentimento do administrador para _\<seu locatário>_** na parte superior esquerda da página **Permissões de API**. Talvez seja necessário que você autentique novamente sua conta na nova janela e permita o acesso ao aplicativo seguindo os avisos.  
...
2. No Intune, acesse a página de **Gerenciamento de dispositivos parceiros**. Em **Configurações do Conector**, configure grupos para atribuição:
   ...
   - Selecione **Incluir** e especifique quais grupos de usuários você deseja alcançar para a inscrição no macOS no Jamf.
   - Use **Excluir** para selecionar grupos de usuários que não se inscreverão no Jamf e, em vez disso, inscreverão seus Macs diretamente no Intune.

   *Excluir* substitui *Incluir*, o que significa que qualquer dispositivo que esteja nos dois grupos é excluído do Jamf e direcionado para a inscrição no Intune.
...
4. Selecione **Salvar** quando quiser para aplicar a configuração.
